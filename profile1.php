...
// Exemplo de dados para o gráfico (valores fictícios)
$valores_imoveis = [];
        ...
        <aside class="w-64 bg-gray-900 text-white flex flex-col">
            ...
            <nav class="flex-grow p-4">
                <ul>
                    ...
                    <li class="mb-2"><a href="#data-table" class="block py-2 px-4 rounded hover:bg-gray-700">Administração de Imóveis</a></li>
                </ul>
            </nav>
        </aside>
